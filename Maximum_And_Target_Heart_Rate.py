...
print("""Fitness levels are:
================
Beginner 
Intermediate
Veryfit
================""")
fitness_level = input("{name} Please enter you fitness level from the list displayed above: ".format(name = name)).lower()
match fitness_level:
	case "beginner":
		now = datetime.now()
		users_date_of_birth = input("Please enter your birth date in the format DD-MM-YYYY: ")
		birth_date = datetime.strptime(users_date_of_birth,"%d-%m-%Y").date()
